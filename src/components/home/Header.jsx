            ...
            <ul>
              ...
              <li>
                ...
                <div className={style.pic}>
                  <Image
                    src={
                      "https://res.cloudinary.com/decjm9mmr/image/upload/q_10,f_auto/creative_design_expertise_ze6yvl.png"
                    }
                    alt="service image showcase"
                    width={300}
                    height={300}
              ...
              <li>
                ...
                <div className={style.pic}>
                  <Image
                    src={
                      "https://res.cloudinary.com/decjm9mmr/image/upload/q_10,f_auto/audio_visual_expertise_lgsik2.png"
                    }
                    alt="service image showcase"
                    width={300}
                    height={300}
              ...
              <li>
                ...
                <div className={style.pic}>
                  <Image
                    src={
                      "https://res.cloudinary.com/decjm9mmr/image/upload/q_10,f_auto/branding_strategy_expertise_ya4vpt.jpg"
                    }
                    alt="service image showcase"
                    width={300}
                    height={300}
