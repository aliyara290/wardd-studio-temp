          ...
          <div className={style.colOne}>
            ...
            <div className={style.rowTwo}>
              <div className={style.card}>
                <div className={style.heading}>
                  ...
                  <div className={style.icon}>
                    ...
                    >
                      ...
                      ></path>
                      <path
                        d="M23.5 20C26.5376 20 29 17.5376 29 14.5C29 11.4624 26.5376 9 23.5 9C20.4624 9 18 11.4624 18 14.5C18 17.5376 20.4624 20 23.5 20Z"
                      ></path>
                      <path
                ...
                <div className={style.description}>
                    <p>
                    we're dedicated to igniting positive transformations alongside our clients. Through our collaborative efforts, we propel brands forward, crafting solutions that inspire growth and success.
                    </p>
                  </div>
              </div>
              <div className={style.card}>
