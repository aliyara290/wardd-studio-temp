  ...
  <ul>
    ...
    <li>
      <a href="https://wa.me/212640454649">
        ...
        >
          <path
            d="M76.21,19.61H23.8a4.18,4.18,0,0,0-4.18,4.18V76.21a4.18,4.18,0,0,0,4.18,4.18H76.21a4.18,4.18,0,0,0,4.18-4.18V23.79A4.18,4.18,0,0,0,76.21,19.61ZM50,68.85A18.85,18.85,0,0,1,41.22,66l-7,1.84L36,60.92A18.79,18.79,0,0,1,31.15,50,18.85,18.85,0,1,1,50,68.85Z"
            transform="translate(-19.61 -19.61)"
          />
          <path
            d="M64.84,55.23c-.82.23-1.35-.1-1.55-.73-.34-1.08-.69-1.35-1.28-1.35s-1.29.54-1.84,1.35a9.32,9.32,0,0,1-1.56,1.84c-.54.41-1.22.68-2,.4s-2.17-.95-4.07-2.51a15.21,15.21,0,0,1-2.84-3.5c-.3-.54-.03-.83.24-1.1.24-.24.54-.63.81-1s.36-.67.54-1.08.11-.82-.05-1.15-.68-1.63-1.49-3.93c-.54-1.56-1.1-1.35-1.49-1.37s-.82-.03-1.25-.03a2.4,2.4,0,0,0-1.73.81c-.6.66-2.28,2.22-2.28,5.42s2.33,6.29,2.66,6.72,4.57,6.97,11.07,9.78c6.5,2.81,6.5,1.87,7.67,1.75s3.8-1.55,4.34-3.05.54-2.79.38-3.05S65.66,55,64.84,55.23Z"
            transform="translate(-19.61 -19.61)"
          />
        </svg>
      </a>
