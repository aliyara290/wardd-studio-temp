          ...
          <div className={style.inner}>
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href={"/work/smiley"}>
                              <span className={style.active}>05/</span>
                            </Link>
                          </li>
                          <li>
            ...
            >
              ...
              <div className={style.mo_text}>
                <p>
                  Beyond its top-notch services, Smiley Dental Clinic is
                  committed to fostering a friendly and relaxing environment for
                  patients. The dedicated team works closely with each patient
                  to understand their unique needs and goals, providing
                  personalized care that leads to lasting results. Whether you
                  need a simple cleaning or a complete smile makeover, Smiley is
                  here to help you achieve the beautiful, healthy teeth you
                  deserve.
                </p>
              </div>
              <div className={style.full_screen}>
                <Image
                  src={"/images/smiley/smiley-full-screen.webp"}
