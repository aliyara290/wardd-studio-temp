                    ...
                    <div className={style.left_part}>
                      ...
                      <div className={style.projects_links}>
                        <ul>
                          <li>
                            <Link href={"/work/crib"}>
                              <span className={style.active}>01/</span>
                            </Link>
                          </li>
                          <li>
            ...
            >
              <div className={style.project_video}>
                <video
                  ...
                  muted={true}
                  playsInline={true}
                  src="/videos/0602(4).mp4"
                ></video>
              </div>
              <div className={style.mo_text}>
                <p>
                  Beyond technical expertise, Crib is dedicated to fostering
                  strong client relationships. The company values collaboration
                  and open communication, ensuring that clients are involved at
                  every stage of the project. Crib's commitment to excellence
                  and attention to detail make it a trusted partner in creating
                  inspiring and enduring spaces.
                </p>
              </div>
              <div className={style.full_screen}>
                <Image
                  src={"/images/crib/crib-full-screen.jpg"}
