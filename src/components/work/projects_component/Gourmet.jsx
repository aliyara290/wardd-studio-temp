...
const Gourmet = ({ deviceType }) => {
  ...
  const bonpainProject = projectDetails.find(
    (project) => project.name === "Gourmet grove"
  );
  if (bonpainProject) {
                        ...
                        <ul>
                          ...
                          <li>
                            <Link href={"/work/gourmet-grove"}>
                              <span className={style.active}>03/</span>
                            </Link>
                          </li>
                          <li>
            ...
            >
              <div className={style.project_video}>
                <video
                  ...
                  muted={true}
                  playsInline={true}
                  src="/videos/0602(3).mp4"
                ></video>
              </div>
              <div className={style.mo_text}>
                <p>
                  Beyond the delicious food, Gourmet Grove focuses on creating
                  an ambiance that mirrors the elegance and warmth of a true
                  Parisian brasserie. The attention to detail in both the menu
                  and the service ensures that every visit is special. From the
                  moment you step in, you are greeted with professionalism and a
                  dedication to making your dining experience extraordinary.
                </p>
              </div>
              <div className={style.full_screen}>
                <Image
                  src={"/images/gourmet/gourmet-full-screen.jpg"}
              ...
              <div className={style.mobile_mockups}>
                <div className={style.mobile}>
                  <Image
                    src={"/images/gourmet/mob-01.webp"}
                    alt="mockup"
                    width={700}
                    height={700}
                  />
                ...
                <div className={`${style.mobile}`}>
                  <Image
                    src={"/images/gourmet/mob-02.webp"}
                    alt="mockup"
                    width={700}
                    height={700}
                  />
