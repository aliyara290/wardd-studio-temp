...
const Wardd = ({ deviceType }) => {
  ...
  const bonpainProject = projectDetails.find(
    (project) => project.name === "wardd studio"
  );
      ...
      <div className={style.content} id="hero">
        <div className={style.container}>
          <div className={style.inner}>
                ...
                <div className={style.explore}>
                  <div className={style.left_part}>
                      ...
                      <ul>
                        ...
                        <li>
                          <Link href={"/work/wardd-studio"}>
                            <span className={style.active}>06/</span>
                          </Link>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className={style.prev_next}>
                      <Link
                        href={"/"}
                        className="pointer-events-none cursor-not-allowed text-slate-500"
                      >
                        <span>next</span>
                        <span className="text-xl">▸</span>
                      </Link>
            ...
            <div className={style.project_mockups}>
              <div className={style.project_video}>
                <video
                  ...
                  muted={true}
                  playsInline={true}
                  src="/videos/0602(2).mp4"
                ></video>
              </div>
              <div className={style.mo_text}>
                <p>
                  Beyond technical capabilities, Wardd is passionate about
                  fostering a community of artists. The studio is a place where
                  creativity thrives, with a dedicated team supporting clients
                  every step of the way. From the initial recording session to
                  the final mastered track, Wardd is here to help achieve
                  musical goals.
                </p>
              </div>
              <div className={style.full_screen}>
                <Image
                  src={"/images/wardd-studio/wardd-full-screen.webp"}
              ...
              <div className={style.mobile_mockups}>
                <div className={style.mobile}>
                  <Image
                    src={"/images/wardd-studio/mob-01.webp"}
                    alt="mockup"
                    width={700}
                    height={700}
                  />
                ...
                <div className={`${style.mobile}`}>
                  <Image
                    src={"/images/wardd-studio/mob-02.webp"}
                    alt="mockup"
                    width={700}
                    height={700}
                  />
